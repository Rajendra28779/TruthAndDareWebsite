...
export class DateService {
  ...
  honeymoontruthlist: string[] = [
   ...
   honeymoondarelist1: string[] = [
    ...
    "Hold hands and look into each other’s eyes for 30 seconds without talking.",
    "Trace the shape of my face with your fingertips, without kissing yet.",
   ];

   /** Romantic — warmer than light, not as explicit as dirty */
   honeymoondarelist2: string[] = [
    "Kiss me slowly for at least 20 seconds.",
    "Give me a 2-minute back rub while I sit or lie comfortably.",
    "Whisper your favorite thing about my body in my ear.",
    "Feed me a bite of something sweet from your fingers.",
    "Dance with me chest-to-chest for one full song (real or imagined).",
    "Kiss along my jawline from ear to chin.",
    "Let me blindfold you (scarf or hands) and guess where I kiss you.",
    "Straddle my lap (clothes on) and kiss my neck for 30 seconds.",
    "Draw a small heart on my skin with your fingertip, then kiss it.",
    "Tell me a romantic memory of us, then kiss me when you finish.",
    "Massage my hands for 1 minute, kissing each palm once.",
    "Lie down together: spoon me and kiss my shoulder three times.",
    "Hum a love song while stroking my hair.",
    "Kiss me somewhere I’ve asked you to avoid all evening—your choice.",
    "Use only your nose and lips to ‘find’ my lips without using hands.",
    "Give me ten soft kisses anywhere above the waist, at my pace.",
    "Recreate our first kiss as closely as you remember.",
    "Warm up massage oil in your hands and rub my lower back for 90 seconds.",
   ];

   honeymoondarelist3: string[] = [
    "Give me a 1-minute shoulder massage.",
    "Lick my lower foot.",
    "Kiss your partner's upper foot.",
    "Remove one piece of clothing from your body.",
    "Smell and sniff any favorite part of your partner's body.",
    "Let your partner remove one piece of your clothing without using their hands.",
    "Kiss your partner's thigh.",
    "Remove one piece of clothing from your body.",
    "Bite your partner's ear gently.",
    "Whisper a dirty compliment in your partner's ear.",
    "Kiss on belly",
    "Say 'Eat Me' to your Partner ",
    "Lick around belly button",
    "let allow Your Partnet to Hold your Private Part",
    "Stay close to eachother's lips but try not to kiss till 40 sec",
    "Lick your partner's upper lip ",
    "Lick your partner's private part ",
    ...
    "Remove one piece of cloth from your body  ",
    "Lick your partner's body (respect each other's comfort).",
    "Play with your partner's private area with consent.",
    "Rub your partner's private area with consent.",
    "Touch your private area to your partner's with consent.",
    "Kiss on belly or try pose '69' — your partner chooses.",
    "Grab your partner and move your hand over their body from behind.",
    "Go close to every part of your partner's body but don't touch for 30 seconds.",
   ];
}
