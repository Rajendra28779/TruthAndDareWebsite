...
export class DateService {
  ...
  honeymoontruthlist: string[] = [
   ...
   honeymoondarelist1: string[] = [
    ...
    "Whisper something Darty in my ear.",
   ...
   honeymoondarelist3: string[] = [
    "Give me a 1-minute shoulder massage.",
    "Lick my  Lower foot",
    "Kiss on your partner's upper foot",
    ...
    "Remove one piece of cloth from your body  ",
    "Lick your partne's Full body ",
    "Play with your partner's Private Part ",
    "Rub your partner's Private Part ",
    "Touch Your Private part with partner Private Part",
    "Kiss on belly Or Try Pose '69' with your partner choice",
